...
dom.attr(test, 'title', 'hello'); // 将title的值打印出来

var title = dom.attr(test, 'title'); // console.log(title); // 打印为 hello
...
var e1 = dom.find('#e1')[0]; // console.log(dom.parent(e1));
...
var t = dom.find('#travel')[0]; // dom.each(dom.children(t), (n) => {
//   dom.style(n, {
//     color: 'red'
//   })
// })

var t1 = dom.find('#t1')[0];
